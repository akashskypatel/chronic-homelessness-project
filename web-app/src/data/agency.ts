...
export const AgencyList: Array<Agency> = [
  {
    ...
    dateCreated: new Date('2021-09-03'),
    dateUpdated: new Date('2021-12-05'),
    dateLastEmailed: new Date('2022-06-01'),
    active: true,
    hours: {
      sunday: 'Closed',
  ...
  },
  {
    ...
    dateCreated: new Date('2010-08-14'),
    dateUpdated: new Date('2021-07-14'),
    dateLastEmailed: new Date('2022-03-14'),
    active: true,
    hours: {
      sunday: 'Closed',
      monday: '8:00AM - 5:00PM',
  ...
  },
  {
    ...
    services: ['Drop-in Center','Food (Meals)', 'Showers/Hygiene'],
    dateCreated: new Date('2022-01-19'),
    dateUpdated: new Date('2022-06-18'),
    dateLastEmailed: new Date('2022-09-13'),
    active: true,
    hours: {
      sunday: 'Closed',
